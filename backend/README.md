...
## Project Structure
    ...
    ├── testapiautoteammemb_96805  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_96805`
...
2. Clone this repo and `cd testapiautoteammemb_96805`
